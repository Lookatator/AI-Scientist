...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_root', type=str, default='saved_data', help='Root directory for experiments')
    parser.add_argument('--experiment_names', nargs='+', default=['test_ga'], help='List of experiment names')
    parser.add_argument('--env_names', nargs='+', default=['Walker-v0'], help='List of environment names')
